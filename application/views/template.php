  ...
  <section id="container">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
            <a href="<?= base_url()?>index.html" class="logo"><b>Coffe Online</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">Yudha Dwipriatma</h5>
                ...
                <a href="<?=base_url('index.php/home')?>">
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/gallery.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Galery</div></p>
                      </a>
                  </li>
                  <li class="active">
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/kategori.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Kategori</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/barang')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/event.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Barang</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/Pelanggan/daftarpelanggan')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/event.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Daftar Pembeli</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/Pelanggan/datapelanggan')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/event.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Data Pembeli</div></p>
                      </a>
                  </li>
